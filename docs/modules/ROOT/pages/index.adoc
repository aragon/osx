...
The Aragon OSx protocol is the foundation layer of the Aragon stack. It lets users create and manage onchain organizations through DAO contracts that can hold assets, execute actions, and manage permissions.

The Aragon OSx protocol provides **three primitives** for users to build their organization:

- **DAO contract:** the onchain account and identity of your organization. It holds assets, executes actions, and manages permissions over itself, plugins, and other contracts.
- **Permissions:** define which accounts, contracts, or plugins can perform specific actions on a DAO, plugin, or framework contract.
