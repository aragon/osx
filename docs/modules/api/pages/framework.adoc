...
[.contract]
[[DAOFactory]]
=== `++DAOFactory++` link:https://github.com/aragon/osx/blob/main/src/framework/dao/DAOFactory.sol[{github-icon},role=heading-link]
...
[.contract]
[[PluginRepoFactory]]
=== `++PluginRepoFactory++` link:https://github.com/aragon/osx/blob/main/src/framework/plugin/repo/PluginRepoFactory.sol[{github-icon},role=heading-link]
...
[.contract]
[[DAORegistry]]
=== `++DAORegistry++` link:https://github.com/aragon/osx/blob/main/src/framework/dao/DAORegistry.sol[{github-icon},role=heading-link]
...
[.contract]
[[PluginRepoRegistry]]
=== `++PluginRepoRegistry++` link:https://github.com/aragon/osx/blob/main/src/framework/plugin/repo/PluginRepoRegistry.sol[{github-icon},role=heading-link]
...
[.contract]
[[MemberRegistry]]
=== `++MemberRegistry++` link:https://github.com/aragon/osx/blob/main/src/framework/member/MemberRegistry.sol[{github-icon},role=heading-link]
...
[.contract]
[[PluginRepo]]
=== `++PluginRepo++` link:https://github.com/aragon/osx/blob/main/src/framework/plugin/repo/PluginRepo.sol[{github-icon},role=heading-link]
...
=== `++PluginSetupProcessor++` link:https://github.com/aragon/osx/blob/main/src/framework/plugin/setup/PluginSetupProcessor.sol[{github-icon},role=heading-link]
