...
:xref-MemberRegistry-revoke-address-: xref:framework.adoc#MemberRegistry-revoke-address-
...
:xref-MemberRegistry-_register-string-: xref:framework.adoc#MemberRegistry-_register-string-
...
:xref-MemberRegistry-_validateSubdomain-string-: xref:framework.adoc#MemberRegistry-_validateSubdomain-string-
...
:xref-MemberRegistry-REVOKE_MEMBER_PERMISSION_ID-bytes32: xref:framework.adoc#MemberRegistry-REVOKE_MEMBER_PERMISSION_ID-bytes32
...
:xref-IMemberRegistry-SubdomainRevoked-address-address-string-: xref:framework.adoc#IMemberRegistry-SubdomainRevoked-address-address-string-
...
* {xref-MemberRegistry-revoke-address-}[`++revoke(member)++`]
...
* {xref-MemberRegistry-_register-string-}[`++_register(subdomain)++`]
* {xref-MemberRegistry-_move-string-}[`++_move(newSubdomain)++`]
* {xref-MemberRegistry-_release-address-}[`++_release(member)++`]
* {xref-MemberRegistry-_validateSubdomain-string-}[`++_validateSubdomain(subdomain)++`]
...
* {xref-IMemberRegistry-SubdomainRevoked-address-address-string-}[`++SubdomainRevoked(member, revoker, subdomain)++`]
...
* {xref-MemberRegistry-REVOKE_MEMBER_PERMISSION_ID-bytes32}[`++bytes32 constant REVOKE_MEMBER_PERMISSION_ID++`]
...
[.contract-item]
[[MemberRegistry-REVOKE_MEMBER_PERMISSION_ID-bytes32]]
==== `[.contract-item-name]#++REVOKE_MEMBER_PERMISSION_ID++#++() → bytes32++` [.item-kind]#public#
...
[.contract-item]
[[MemberRegistry-revoke-address-]]
==== `[.contract-item-name]#++revoke++#++(address member)++` [.item-kind]#external#

Forcibly revoke a member's subdomain. Governed.         Requires REVOKE_MEMBER_PERMISSION_ID on this contract (OSx permission system).
...
[.contract-item]
[[MemberRegistry-_register-string-]]
==== `[.contract-item-name]#++_register++#++(string subdomain) → bytes32 label++` [.item-kind]#internal#
...
[.contract-item]
[[MemberRegistry-_validateSubdomain-string-]]
==== `[.contract-item-name]#++_validateSubdomain++#++(string subdomain)++` [.item-kind]#internal#
