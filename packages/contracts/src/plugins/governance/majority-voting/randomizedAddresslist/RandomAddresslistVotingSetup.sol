...
contract RandomAddresslistVotingSetup is PluginSetup {
    ...
    function prepareInstallation(
        ...
        // Decode `_data` to extract the params needed for deploying and initializing `AddressAddresslistVoting` plugin.
        ...
        plugin = createERC1967Proxy(
            ...
            abi.encodeWithSelector(
                RandomAddresslistVoting.initialize.selector,
                _dao,
                votingSettings,
                members
            )
