...
abstract contract PermissionManager is Initializable {
    ...
    function grantWithDelay(
        ...
        // The bad thing is we're storing the member in 2 structure - more gas. Better would be to either store in one of them,
        // but if you do that, that means pm2.sol solution and you can see how shit it is.
        Role storage role = roles[roleHash(_where, _permissionId)];
