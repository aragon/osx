...
contract TokenVotingSetup is PluginSetup {
        ...
        )
    {
        ...
        // Prepare permissions
        permissions = new PermissionLib.AdvancedPermission[](tokenSettings.addr != address(0) ? 3 : 4);
        ...
        if (tokenSettings.addr == address(0)) {
            ...
            permissions[3] = PermissionLib.AdvancedPermission(
                PermissionLib.Operation.Grant,
                token,
                _dao,
                NO_ORACLE,
    ...
    function prepareUninstallation(
        ...
        permissions = new PermissionLib.AdvancedPermission[](isGovernanceERC20 ? 4 : 3);
