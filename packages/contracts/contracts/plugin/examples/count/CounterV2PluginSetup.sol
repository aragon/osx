...
contract CounterV2PluginSetup is PluginSetup {
        ...
        )
    {
        ...
        permissions = new PermissionLib.AdvancedPermission[](_multiplyHelper == address(0) ? 3 : 2);
        ...
        )
    {
        ...
        permissions = new PermissionLib.AdvancedPermission[](1);
        permissions[0] = PermissionLib.AdvancedPermission(
    ...
    function prepareUninstallation(
        ...
        permissions = new PermissionLib.AdvancedPermission[](activeHelpers.length != 0 ? 3 : 2);
