...
contract MerkleMinter is AragonUpgradablePlugin {
    ...
    /// @notice adds a IERC165 to check whether contract supports MerkleMinter interface or not.
    /// @dev See {AragonUpgradablePlugin-supportsInterface}.
    /// @return bool whether it supports the IERC165 or MerkleMinter
