...
import {PluginUUPSUpgradeableV3Mock} from "./PluginUUPSUpgradeableV3Mock.sol";

// The second version of plugin manager.
contract PluginSetupV3Mock is PluginSetup {
    PluginUUPSUpgradeableV3Mock public helperBase;
    PluginUUPSUpgradeableV3Mock public pluginBase;
    ...
    constructor() {
        ...
        helperBase = new PluginUUPSUpgradeableV3Mock();
        // V3 version
        pluginBase = new PluginUUPSUpgradeableV3Mock();
    }
