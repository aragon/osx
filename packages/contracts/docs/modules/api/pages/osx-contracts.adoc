...
:xref-ProtocolVersion-protocolVersion--: xref:osx-contracts.adoc#ProtocolVersion-protocolVersion--
...
:xref-IDAO-MetadataSet-bytes-: xref:osx-contracts.adoc#IDAO-MetadataSet-bytes-
:xref-IDAO-StandardCallbackRegistered-bytes4-bytes4-bytes4-: xref:osx-contracts.adoc#IDAO-StandardCallbackRegistered-bytes4-bytes4-bytes4-
:xref-IDAO-Deposited-address-address-uint256-string-: xref:osx-contracts.adoc#IDAO-Deposited-address-address-uint256-string-
:xref-IDAO-NativeTokenDeposited-address-uint256-: xref:osx-contracts.adoc#IDAO-NativeTokenDeposited-address-uint256-
:xref-IDAO-TrustedForwarderSet-address-: xref:osx-contracts.adoc#IDAO-TrustedForwarderSet-address-
:xref-IDAO-hasPermission-address-address-bytes32-bytes-: xref:osx-contracts.adoc#IDAO-hasPermission-address-address-bytes32-bytes-
:xref-IDAO-setMetadata-bytes-: xref:osx-contracts.adoc#IDAO-setMetadata-bytes-
:xref-IDAO-execute-bytes32-struct-IDAO-Action---uint256-: xref:osx-contracts.adoc#IDAO-execute-bytes32-struct-IDAO-Action---uint256-
:xref-IDAO-deposit-address-uint256-string-: xref:osx-contracts.adoc#IDAO-deposit-address-uint256-string-
:xref-IDAO-setTrustedForwarder-address-: xref:osx-contracts.adoc#IDAO-setTrustedForwarder-address-
:xref-IDAO-getTrustedForwarder--: xref:osx-contracts.adoc#IDAO-getTrustedForwarder--
:xref-IDAO-setSignatureValidator-address-: xref:osx-contracts.adoc#IDAO-setSignatureValidator-address-
:xref-IDAO-isValidSignature-bytes32-bytes-: xref:osx-contracts.adoc#IDAO-isValidSignature-bytes32-bytes-
:xref-IDAO-registerStandardCallback-bytes4-bytes4-bytes4-: xref:osx-contracts.adoc#IDAO-registerStandardCallback-bytes4-bytes4-bytes4-
:xref-IDAO-MetadataSet-bytes-: xref:osx-contracts.adoc#IDAO-MetadataSet-bytes-
:xref-IDAO-Executed-address-bytes32-struct-IDAO-Action---uint256-uint256-bytes---: xref:osx-contracts.adoc#IDAO-Executed-address-bytes32-struct-IDAO-Action---uint256-uint256-bytes---
:xref-IDAO-StandardCallbackRegistered-bytes4-bytes4-bytes4-: xref:osx-contracts.adoc#IDAO-StandardCallbackRegistered-bytes4-bytes4-bytes4-
:xref-IDAO-Deposited-address-address-uint256-string-: xref:osx-contracts.adoc#IDAO-Deposited-address-address-uint256-string-
:xref-IDAO-NativeTokenDeposited-address-uint256-: xref:osx-contracts.adoc#IDAO-NativeTokenDeposited-address-uint256-
:xref-IDAO-TrustedForwarderSet-address-: xref:osx-contracts.adoc#IDAO-TrustedForwarderSet-address-
:xref-IDAO-SignatureValidatorSet-address-: xref:osx-contracts.adoc#IDAO-SignatureValidatorSet-address-
...
:xref-DaoAuthorizableUpgradeable-__DaoAuthorizableUpgradeable_init-contract-IDAO-: xref:osx-contracts.adoc#DaoAuthorizableUpgradeable-__DaoAuthorizableUpgradeable_init-contract-IDAO-
:xref-DaoAuthorizableUpgradeable-dao--: xref:osx-contracts.adoc#DaoAuthorizableUpgradeable-dao--
...
:Action: pass:normal[xref:#IDAO-Action[`++Action++`]]
...
:execute: pass:normal[xref:#IDAO-execute-bytes32-struct-IDAO-Action---uint256-[`++execute++`]]
:Executed: pass:normal[xref:#IDAO-Executed-address-bytes32-struct-IDAO-Action---uint256-uint256-bytes---[`++Executed++`]]
...
:SignatureValidatorSet: pass:normal[xref:#IDAO-SignatureValidatorSet-address-[`++SignatureValidatorSet++`]]
...
[.contract]
[[IDAO]]
=== `++IDAO++` link:https://github.com/aragon/osx.git/blob/v1.4.0-rc0/src/core/dao/IDAO.sol[{github-icon},role=heading-link]
...
* {xref-IDAO-execute-bytes32-struct-IDAO-Action---uint256-}[`++execute(_callId, _actions, _allowFailureMap)++`]
...
* {xref-IDAO-setSignatureValidator-address-}[`++setSignatureValidator(_signatureValidator)++`]
...
--
* {xref-IDAO-MetadataSet-bytes-}[`++MetadataSet(metadata)++`]
* {xref-IDAO-Executed-address-bytes32-struct-IDAO-Action---uint256-uint256-bytes---}[`++Executed(actor, callId, actions, allowFailureMap, failureMap, execResults)++`]
* {xref-IDAO-StandardCallbackRegistered-bytes4-bytes4-bytes4-}[`++StandardCallbackRegistered(interfaceId, callbackSelector, magicNumber)++`]
* {xref-IDAO-Deposited-address-address-uint256-string-}[`++Deposited(sender, token, amount, _reference)++`]
* {xref-IDAO-NativeTokenDeposited-address-uint256-}[`++NativeTokenDeposited(sender, amount)++`]
* {xref-IDAO-TrustedForwarderSet-address-}[`++TrustedForwarderSet(forwarder)++`]
* {xref-IDAO-SignatureValidatorSet-address-}[`++SignatureValidatorSet(signatureValidator)++`]
...
[.contract-item]
[[IDAO-execute-bytes32-struct-IDAO-Action---uint256-]]
==== `[.contract-item-name]#++execute++#++(bytes32 _callId, struct IDAO.Action[] _actions, uint256 _allowFailureMap) → bytes[], uint256++` [.item-kind]#external#
...
==== `[.contract-item-name]#++setSignatureValidator++#++(address _signatureValidator)++` [.item-kind]#external#
...
[.contract-item]
[[IDAO-Executed-address-bytes32-struct-IDAO-Action---uint256-uint256-bytes---]]
==== `[.contract-item-name]#++Executed++#++(address indexed actor, bytes32 callId, struct IDAO.Action[] actions, uint256 allowFailureMap, uint256 failureMap, bytes[] execResults)++` [.item-kind]#event#
...
[.contract-item]
[[IDAO-SignatureValidatorSet-address-]]
==== `[.contract-item-name]#++SignatureValidatorSet++#++(address signatureValidator)++` [.item-kind]#event#
