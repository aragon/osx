...
To learn more about the architecture of the system, visit the section explaining [The Infrastructure Behind the AraongOS DAO Framework](./01-how-it-works/02-framework/index.md).
