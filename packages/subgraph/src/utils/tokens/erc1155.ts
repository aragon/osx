...
export function supportsERC1155(token: Address): bool {
  ...
  let introspection_ERC165 = supportsInterface(erc1155, ERC165_MAGIC_VALUE); // ERC165
  let introspection_ERC1155 = supportsInterface(erc1155, ERC1155_MAGIC_VALUE); // ERC1155
